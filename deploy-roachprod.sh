...
roachprod run ${NIFI} 'sudo echo -e "server.1='"$CLUSTER"'-0001:2888:3888" >> /opt/nifi/nifi-current/conf/zookeeper.properties'
roachprod run ${NIFI} 'sudo echo -e "server.2='"$CLUSTER"'-0002:2888:3888" >> /opt/nifi/nifi-current/conf/zookeeper.properties'
roachprod run ${NIFI} 'sudo echo -e "server.3='"$CLUSTER"'-0003:2888:3888" >> /opt/nifi/nifi-current/conf/zookeeper.properties'
